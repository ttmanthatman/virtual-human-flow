...
- 中间：聊天室；当回复节奏为连续多条或短句爆发时，会把虚拟人的自然语言回复分成多条消息展示。每轮说话前还会把场景、心理判断、记忆浮现和开口冲动作为临时“心理流”streaming 到聊天区；第一句说完后，前置心理流折叠，只保留最终发言，发言后的状态余波仍可继续 streaming，并在余波后继续补话或收住沉默。
