...
- 输出：auth session、persona dossiers、当前用户 conversation history、当前角色房间 room messages、当前角色下所有用户 history summaries/messages、conversation states、conversation audits、conversation audit export、审计删除级联清理结果、角色重置清理结果、update status/SSE。
