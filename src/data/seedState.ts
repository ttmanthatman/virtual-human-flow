...
export const seedState: CharacterState = {
  ...
  scene: {
    ...
    llmContext: "让回复带一点雨夜工作室的收束感；她可以借画稿、茶、雨声转移直接情绪。",
  },
};
